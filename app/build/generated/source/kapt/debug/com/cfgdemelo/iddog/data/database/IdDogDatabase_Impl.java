...
public final class IdDogDatabase_Impl extends IdDogDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `USER` (`_id` TEXT NOT NULL, `__v` INTEGER NOT NULL, `createdAt` TEXT NOT NULL, `email` TEXT NOT NULL, `token` TEXT NOT NULL, `updatedAt` TEXT NOT NULL, PRIMARY KEY(`_id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '7d436469c144f7851a3dc459385a3995')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsUSER.put("__v", new TableInfo.Column("__v", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsUSER.put("updatedAt", new TableInfo.Column("updatedAt", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "7d436469c144f7851a3dc459385a3995", "b3dfcdf27fbf8603dc1f27731b503c4e");
